...
const passwordGenerator=() =>{
   ...
   // useRef() hum ne input mei es liye lagya ky password me jesy hi changing hu gi 
   // range ko min ya max krte hn us ki waja se input password me changing aye gi es waja se 
   // hum ne input password me passwordRef yani useRef ko ref me rakha h 
   ...
   console.log("useCallBackTest", passwordGenerator)
